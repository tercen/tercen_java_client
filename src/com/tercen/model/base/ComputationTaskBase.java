...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.ComputationTask_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static ComputationTask createFromJson(LinkedHashMap m) {return ComputationTaskBase.fromJson(m);} 
public static ComputationTask fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class ComputationTask in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.ComputationTask_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.ComputationTask_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
