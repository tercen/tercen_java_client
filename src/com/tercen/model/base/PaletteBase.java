...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Palette_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static Palette createFromJson(LinkedHashMap m) {return PaletteBase.fromJson(m);} 
public static Palette fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Palette in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Palette_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Palette_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
