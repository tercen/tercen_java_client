...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Ulimits_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static Ulimits createFromJson(LinkedHashMap m) {return UlimitsBase.fromJson(m);} 
public static Ulimits fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.Ulimits_CLASS :
return new Ulimits(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Ulimits in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Ulimits_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Ulimits_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
