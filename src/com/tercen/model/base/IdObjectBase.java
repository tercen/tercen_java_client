...
public class IdObjectBase extends BaseObject {
	...
	public IdObjectBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.IdObject_CLASS ? m.get(Vocabulary.KIND) : null);
		this.id = (String) m.get(Vocabulary.id_DP);
	}

	public static IdObject createFromJson(LinkedHashMap m) {
		return IdObjectBase.fromJson(m);
	}

	public static IdObject fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException("bad kind : " + kind + " for class IdObject in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.IdObject_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.IdObject_CLASS)
