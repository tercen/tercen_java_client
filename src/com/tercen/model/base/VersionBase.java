...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Version_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static Version createFromJson(LinkedHashMap m) {return VersionBase.fromJson(m);} 
public static Version fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.Version_CLASS :
return new Version(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Version in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Version_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Version_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
...
m.put(Vocabulary.features_DP, features);
return m;
}
}