...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.CrosstabTable_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static CrosstabTable createFromJson(LinkedHashMap m) {return CrosstabTableBase.fromJson(m);} 
public static CrosstabTable fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.CrosstabTable_CLASS :
return new CrosstabTable(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class CrosstabTable in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.CrosstabTable_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.CrosstabTable_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
