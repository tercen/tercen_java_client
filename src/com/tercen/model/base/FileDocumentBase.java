...
public class FileDocumentBase extends ProjectDocument {
	...
	public static FileDocument fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class FileDocument in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.FileDocument_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.FileDocument_CLASS)
