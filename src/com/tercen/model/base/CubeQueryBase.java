...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.CubeQuery_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static CubeQuery createFromJson(LinkedHashMap m) {return CubeQueryBase.fromJson(m);} 
public static CubeQuery fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.CubeQuery_CLASS :
return new CubeQuery(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class CubeQuery in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.CubeQuery_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.CubeQuery_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
