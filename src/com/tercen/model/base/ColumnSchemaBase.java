...
public class ColumnSchemaBase extends IdObject {
	...
	public ColumnSchemaBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.ColumnSchema_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static ColumnSchema createFromJson(LinkedHashMap m) {
		return ColumnSchemaBase.fromJson(m);
	}

	public static ColumnSchema fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class ColumnSchema in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.ColumnSchema_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.ColumnSchema_CLASS)
