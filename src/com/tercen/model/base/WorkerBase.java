...
public class WorkerBase extends BaseObject {
	...
	public WorkerBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.Worker_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static Worker createFromJson(LinkedHashMap m) {
		return WorkerBase.fromJson(m);
	}

	public static Worker fromJson(LinkedHashMap m) {
		String kind = (String) m.get(Vocabulary.KIND);
		switch (kind) {
		case Vocabulary.Worker_CLASS:
			return new Worker(m);
		default:
			throw new IllegalArgumentException("bad kind : " + kind + " for class Worker in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.Worker_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.Worker_CLASS)
