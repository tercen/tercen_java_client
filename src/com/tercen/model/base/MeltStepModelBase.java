...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.MeltStepModel_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static MeltStepModel createFromJson(LinkedHashMap m) {return MeltStepModelBase.fromJson(m);} 
public static MeltStepModel fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.MeltStepModel_CLASS :
return new MeltStepModel(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class MeltStepModel in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.MeltStepModel_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.MeltStepModel_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
