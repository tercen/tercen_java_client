...
public class RunWebAppTaskBase extends ProjectTask {
	...
	public RunWebAppTaskBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.RunWebAppTask_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static RunWebAppTask createFromJson(LinkedHashMap m) {
		return RunWebAppTaskBase.fromJson(m);
	}

	public static RunWebAppTask fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class RunWebAppTask in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.RunWebAppTask_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.RunWebAppTask_CLASS)
