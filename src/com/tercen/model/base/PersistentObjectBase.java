...
public class PersistentObjectBase extends IdObject {
	...
	public PersistentObjectBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.PersistentObject_CLASS ? m.get(Vocabulary.KIND)
						: null);
		this.isDeleted = (boolean) m.get(Vocabulary.isDeleted_DP);
		this.rev = (String) m.get(Vocabulary.rev_DP);
	}

	public static PersistentObject createFromJson(LinkedHashMap m) {
		return PersistentObjectBase.fromJson(m);
	}

	public static PersistentObject fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class PersistentObject in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.PersistentObject_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.PersistentObject_CLASS)
