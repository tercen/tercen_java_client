...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.ViesInfo_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static ViesInfo createFromJson(LinkedHashMap m) {return ViesInfoBase.fromJson(m);} 
public static ViesInfo fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.ViesInfo_CLASS :
return new ViesInfo(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class ViesInfo in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.ViesInfo_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.ViesInfo_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
