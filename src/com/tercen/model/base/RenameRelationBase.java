...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.RenameRelation_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static RenameRelation createFromJson(LinkedHashMap m) {return RenameRelationBase.fromJson(m);} 
public static RenameRelation fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.RenameRelation_CLASS :
return new RenameRelation(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class RenameRelation in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.RenameRelation_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.RenameRelation_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
