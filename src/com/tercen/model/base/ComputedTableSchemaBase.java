...
public class ComputedTableSchemaBase extends Schema {
	...
	public static ComputedTableSchema createFromJson(LinkedHashMap m) {
		return ComputedTableSchemaBase.fromJson(m);
	}

	public static ComputedTableSchema fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class ComputedTableSchema in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.ComputedTableSchema_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.ComputedTableSchema_CLASS)
