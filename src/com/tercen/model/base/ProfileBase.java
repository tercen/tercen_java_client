...
public class ProfileBase extends BaseObject {
	...
	public ProfileBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.Profile_CLASS ? m.get(Vocabulary.KIND) : null);
		this.name = (String) m.get(Vocabulary.name_DP);
	}

	public static Profile createFromJson(LinkedHashMap m) {
		return ProfileBase.fromJson(m);
	}

	public static Profile fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException("bad kind : " + kind + " for class Profile in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.Profile_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.Profile_CLASS)
