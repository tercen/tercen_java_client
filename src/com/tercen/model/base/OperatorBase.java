...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Operator_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static Operator createFromJson(LinkedHashMap m) {return OperatorBase.fromJson(m);} 
public static Operator fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Operator in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Operator_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Operator_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
