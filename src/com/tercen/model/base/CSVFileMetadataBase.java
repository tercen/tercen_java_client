...
public class CSVFileMetadataBase extends FileMetadata {
	...
	public CSVFileMetadataBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.CSVFileMetadata_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static CSVFileMetadata createFromJson(LinkedHashMap m) {
		return CSVFileMetadataBase.fromJson(m);
	}

	public static CSVFileMetadata fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class CSVFileMetadata in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.CSVFileMetadata_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.CSVFileMetadata_CLASS)
