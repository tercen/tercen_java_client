...
public class FileMetadataBase extends BaseObject {
	...
	public FileMetadataBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.FileMetadata_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static FileMetadata createFromJson(LinkedHashMap m) {
		return FileMetadataBase.fromJson(m);
	}

	public static FileMetadata fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class FileMetadata in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.FileMetadata_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.FileMetadata_CLASS)
