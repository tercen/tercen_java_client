...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.SubscriptionPlan_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static SubscriptionPlan createFromJson(LinkedHashMap m) {return SubscriptionPlanBase.fromJson(m);} 
public static SubscriptionPlan fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.SubscriptionPlan_CLASS :
return new SubscriptionPlan(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class SubscriptionPlan in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.SubscriptionPlan_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.SubscriptionPlan_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
