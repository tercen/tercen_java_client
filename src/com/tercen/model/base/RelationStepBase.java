...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.RelationStep_CLASS ? m.get(Vocabulary.KIND) : null);
}

public static RelationStep createFromJson(LinkedHashMap m) {return RelationStepBase.fromJson(m);} 
public static RelationStep fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class RelationStep in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.RelationStep_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.RelationStep_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
