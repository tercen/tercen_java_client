...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.ProjectTask_CLASS ? m.get(Vocabulary.KIND) : null);
this.projectId = (String)m.get(Vocabulary.projectId_DP) ;
}

public static ProjectTask createFromJson(LinkedHashMap m) {return ProjectTaskBase.fromJson(m);} 
public static ProjectTask fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class ProjectTask in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.ProjectTask_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.ProjectTask_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
