...
public class WhereRelationBase extends Relation {
	...
	public static WhereRelation createFromJson(LinkedHashMap m) {
		return WhereRelationBase.fromJson(m);
	}

	public static WhereRelation fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class WhereRelation in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.WhereRelation_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.WhereRelation_CLASS)
