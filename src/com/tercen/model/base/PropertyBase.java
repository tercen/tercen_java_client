...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Property_CLASS ? m.get(Vocabulary.KIND) : null);
this.name = (String)m.get(Vocabulary.name_DP) ;
this.description = (String)m.get(Vocabulary.description_DP) ;
}

public static Property createFromJson(LinkedHashMap m) {return PropertyBase.fromJson(m);} 
public static Property fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Property in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Property_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Property_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
