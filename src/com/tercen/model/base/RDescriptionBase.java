...
public class RDescriptionBase extends BaseObject {
	...
	public RDescriptionBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.RDescription_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static RDescription createFromJson(LinkedHashMap m) {
		return RDescriptionBase.fromJson(m);
	}

	public static RDescription fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class RDescription in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.RDescription_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.RDescription_CLASS)
