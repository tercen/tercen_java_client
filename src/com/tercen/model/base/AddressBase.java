...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Address_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static Address createFromJson(LinkedHashMap m) {return AddressBase.fromJson(m);} 
public static Address fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.Address_CLASS :
return new Address(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Address in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Address_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Address_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
