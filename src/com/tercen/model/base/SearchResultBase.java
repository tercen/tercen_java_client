...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.SearchResult_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static SearchResult createFromJson(LinkedHashMap m) {return SearchResultBase.fromJson(m);} 
public static SearchResult fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.SearchResult_CLASS :
return new SearchResult(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class SearchResult in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.SearchResult_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.SearchResult_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
