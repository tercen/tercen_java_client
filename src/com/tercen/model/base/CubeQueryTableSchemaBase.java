...
public class CubeQueryTableSchemaBase extends Schema {
	...
	public CubeQueryTableSchemaBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.CubeQueryTableSchema_CLASS ? m.get(Vocabulary.KIND)
						: null);
	...
	public static CubeQueryTableSchema createFromJson(LinkedHashMap m) {
		return CubeQueryTableSchemaBase.fromJson(m);
	}

	public static CubeQueryTableSchema fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class CubeQueryTableSchema in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.CubeQueryTableSchema_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.CubeQueryTableSchema_CLASS)
