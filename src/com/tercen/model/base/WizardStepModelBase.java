...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.WizardStepModel_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static WizardStepModel createFromJson(LinkedHashMap m) {return WizardStepModelBase.fromJson(m);} 
public static WizardStepModel fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.WizardStepModel_CLASS :
return new WizardStepModel(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class WizardStepModel in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.WizardStepModel_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.WizardStepModel_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
