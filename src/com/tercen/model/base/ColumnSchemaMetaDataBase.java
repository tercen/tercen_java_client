...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.ColumnSchemaMetaData_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static ColumnSchemaMetaData createFromJson(LinkedHashMap m) {return ColumnSchemaMetaDataBase.fromJson(m);} 
public static ColumnSchemaMetaData fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.ColumnSchemaMetaData_CLASS :
return new ColumnSchemaMetaData(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class ColumnSchemaMetaData in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.ColumnSchemaMetaData_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.ColumnSchemaMetaData_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
