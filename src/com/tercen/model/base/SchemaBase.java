...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Schema_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static Schema createFromJson(LinkedHashMap m) {return SchemaBase.fromJson(m);} 
public static Schema fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Schema in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Schema_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Schema_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
