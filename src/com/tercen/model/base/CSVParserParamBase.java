...
public class CSVParserParamBase extends BaseObject {
	...
	public CSVParserParamBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.CSVParserParam_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static CSVParserParam createFromJson(LinkedHashMap m) {
		return CSVParserParamBase.fromJson(m);
	}

	public static CSVParserParam fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class CSVParserParam in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.CSVParserParam_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.CSVParserParam_CLASS)
