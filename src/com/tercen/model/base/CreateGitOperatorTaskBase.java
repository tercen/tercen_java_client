...
public class CreateGitOperatorTaskBase extends Task {
	...
	public CreateGitOperatorTaskBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.CreateGitOperatorTask_CLASS ? m.get(Vocabulary.KIND)
						: null);
	...
	public static CreateGitOperatorTask createFromJson(LinkedHashMap m) {
		return CreateGitOperatorTaskBase.fromJson(m);
	}

	public static CreateGitOperatorTask fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class CreateGitOperatorTask in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.CreateGitOperatorTask_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.CreateGitOperatorTask_CLASS)
