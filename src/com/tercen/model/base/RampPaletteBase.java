...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.RampPalette_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static RampPalette createFromJson(LinkedHashMap m) {return RampPaletteBase.fromJson(m);} 
public static RampPalette fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.RampPalette_CLASS :
return new RampPalette(m);
case Vocabulary.JetPalette_CLASS :
return new JetPalette(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class RampPalette in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.RampPalette_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.RampPalette_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
