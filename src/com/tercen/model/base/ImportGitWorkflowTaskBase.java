...
public class ImportGitWorkflowTaskBase extends ProjectTask {
	...
	public ImportGitWorkflowTaskBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.ImportGitWorkflowTask_CLASS ? m.get(Vocabulary.KIND)
						: null);
	...
	public static ImportGitWorkflowTask createFromJson(LinkedHashMap m) {
		return ImportGitWorkflowTaskBase.fromJson(m);
	}

	public static ImportGitWorkflowTask fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class ImportGitWorkflowTask in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.ImportGitWorkflowTask_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.ImportGitWorkflowTask_CLASS)
