...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Document_CLASS ? m.get(Vocabulary.KIND) : null);
...
if (m.get(Vocabulary.acl_OP) == null) this.acl = new Acl();
else this.acl = AclBase.fromJson((LinkedHashMap)m.get(Vocabulary.acl_OP) );
...
public static Document createFromJson(LinkedHashMap m) {return DocumentBase.fromJson(m);} 
public static Document fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
...
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Document in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Document_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Document_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
