...
super(m);
this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String)m.get(Vocabulary.SUBKIND)   : (String)(m.get(Vocabulary.KIND) != Vocabulary.Filter_CLASS ? m.get(Vocabulary.KIND) : null);
...
public static Filter createFromJson(LinkedHashMap m) {return FilterBase.fromJson(m);} 
public static Filter fromJson(LinkedHashMap m) {String kind = (String)m.get(Vocabulary.KIND);
switch (kind) {
case Vocabulary.Filter_CLASS :
return new Filter(m);
case Vocabulary.NamedFilter_CLASS :
return new NamedFilter(m);
default : throw new IllegalArgumentException(  "bad kind : " + kind +" for class Filter in fromJson constructor");
}
}

public LinkedHashMap toJson() {
LinkedHashMap m = super.toJson();m.put(Vocabulary.KIND, Vocabulary.Filter_CLASS);
if (this.subKind != null && this.subKind != Vocabulary.Filter_CLASS) m.put(Vocabulary.SUBKIND, this.subKind);
