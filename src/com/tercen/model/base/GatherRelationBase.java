...
public class GatherRelationBase extends Relation {
	...
	public GatherRelationBase(LinkedHashMap m) {
		...
		this.names = new LinkedList<String>((Collection<? extends String>) (m.get(Vocabulary.names_DP)));
	...
	public static GatherRelation createFromJson(LinkedHashMap m) {
		return GatherRelationBase.fromJson(m);
	}

	public static GatherRelation fromJson(LinkedHashMap m) {
		...
		default:
			throw new IllegalArgumentException(
					"bad kind : " + kind + " for class GatherRelation in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.GatherRelation_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.GatherRelation_CLASS)
