...
public class BillingInfoBase extends BaseObject {
	...
	public BillingInfoBase(LinkedHashMap m) {
		...
		this.subKind = m.get(Vocabulary.SUBKIND) != null ? (String) m.get(Vocabulary.SUBKIND)
				: (String) (m.get(Vocabulary.KIND) != Vocabulary.BillingInfo_CLASS ? m.get(Vocabulary.KIND) : null);
	...
	public static BillingInfo createFromJson(LinkedHashMap m) {
		return BillingInfoBase.fromJson(m);
	}

	public static BillingInfo fromJson(LinkedHashMap m) {
		String kind = (String) m.get(Vocabulary.KIND);
		switch (kind) {
		case Vocabulary.BillingInfo_CLASS:
			return new BillingInfo(m);
		default:
			throw new IllegalArgumentException("bad kind : " + kind + " for class BillingInfo in fromJson constructor");
		}
	}

	public LinkedHashMap toJson() {
		LinkedHashMap m = super.toJson();
		m.put(Vocabulary.KIND, Vocabulary.BillingInfo_CLASS);
		if (this.subKind != null && this.subKind != Vocabulary.BillingInfo_CLASS)
