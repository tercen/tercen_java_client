...
public URI getBaseUri() { return URI.create("api/v1/folder");}
String getServiceName() {return "FolderDocument";}

LinkedHashMap toJson(FolderDocument object) { return object.toJson();}
public FolderDocument fromJson(LinkedHashMap m,boolean useFactory) { if (m == null) return null; if (useFactory) return FolderDocumentBase.fromJson(m); return new FolderDocument(m);}

public List<FolderDocument> findFolderByParentFolderAndName(List startKey,List endKey, int limit , int skip , boolean descending , boolean useFactory) throws ServiceError{
