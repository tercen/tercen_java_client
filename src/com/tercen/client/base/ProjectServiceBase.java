...
public class ProjectServiceBase extends HttpClientService<Project> {
	...
	LinkedHashMap toJson(Project object) {
		return object.toJson();
	}

	public Project fromJson(LinkedHashMap m, boolean useFactory) {
		if (m == null)
			return null;
		if (useFactory)
	...
	public List<Project> findByIsPublicAndLastModifiedDate(List startKey, List endKey, int limit, int skip,
			boolean descending, boolean useFactory) throws ServiceError {
		return findStartKeys("findByIsPublicAndLastModifiedDate", startKey, endKey, limit, skip, descending,
				useFactory);
	}

	public List<Project> findByTeamAndIsPublicAndLastModifiedDate(List startKey, List endKey, int limit, int skip,
			boolean descending, boolean useFactory) throws ServiceError {
		return findStartKeys("findByTeamAndIsPublicAndLastModifiedDate", startKey, endKey, limit, skip, descending,
				useFactory);
	}
