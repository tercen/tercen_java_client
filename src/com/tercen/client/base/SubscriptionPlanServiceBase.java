...
public URI getBaseUri() { return URI.create("api/v1/subscription");}
String getServiceName() {return "SubscriptionPlan";}

LinkedHashMap toJson(SubscriptionPlan object) { return object.toJson();}
public SubscriptionPlan fromJson(LinkedHashMap m,boolean useFactory) { if (m == null) return null; if (useFactory) return SubscriptionPlanBase.fromJson(m); return new SubscriptionPlan(m);}
...
public List<SubscriptionPlan> findSubscriptionPlanByCheckoutSessionId(List keys, boolean useFactory  ) throws ServiceError{
...
public SubscriptionPlan createSubscriptionPlan(String userId,String plan,String successUrl,String cancelUrl) throws ServiceError {
...
public SubscriptionPlan updatePaymentMethod(String subscriptionPlanId,String successUrl,String cancelUrl) throws ServiceError {
SubscriptionPlan answer = null;
Response response = null;
try {
