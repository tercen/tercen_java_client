...
public class UserServiceBase extends HttpClientService<User> {
	...
	LinkedHashMap toJson(User object) {
		return object.toJson();
	}

	public User fromJson(LinkedHashMap m, boolean useFactory) {
		if (m == null)
			return null;
		if (useFactory)
	...
	public List<User> findUserByCreatedDateAndName(List startKey, List endKey, int limit, int skip, boolean descending,
