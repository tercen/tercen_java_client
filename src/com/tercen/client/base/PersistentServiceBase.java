...
public URI getBaseUri() { return URI.create("api/v1/po");}
String getServiceName() {return "PersistentObject";}

LinkedHashMap toJson(PersistentObject object) { return object.toJson();}
public PersistentObject fromJson(LinkedHashMap m,boolean useFactory) { if (m == null) return null; if (useFactory) return PersistentObjectBase.fromJson(m); return new PersistentObject(m);}
