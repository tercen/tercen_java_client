...
public URI getBaseUri() { return URI.create("api/v1/schema");}
String getServiceName() {return "Schema";}

LinkedHashMap toJson(Schema object) { return object.toJson();}
public Schema fromJson(LinkedHashMap m,boolean useFactory) { if (m == null) return null; if (useFactory) return SchemaBase.fromJson(m); return new Schema(m);}
...
public List<Schema> findSchemaByDataDirectory(List startKey,List endKey, int limit , int skip , boolean descending , boolean useFactory) throws ServiceError{
