...
public URI getBaseUri() { return URI.create("api/v1/lock");}
String getServiceName() {return "Lock";}

LinkedHashMap toJson(Lock object) { return object.toJson();}
public Lock fromJson(LinkedHashMap m,boolean useFactory) { if (m == null) return null; if (useFactory) return LockBase.fromJson(m); return new Lock(m);}
