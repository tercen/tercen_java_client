...
public class ActivityServiceBase extends HttpClientService<Activity> {
	...
	LinkedHashMap toJson(Activity object) {
		return object.toJson();
	}

	public Activity fromJson(LinkedHashMap m, boolean useFactory) {
		if (m == null)
			return null;
		if (useFactory)
	...
	public List<Activity> findByUserAndDate(List startKey, List endKey, int limit, int skip, boolean descending,
	...
	public List<Activity> findByTeamAndDate(List startKey, List endKey, int limit, int skip, boolean descending,
			boolean useFactory) throws ServiceError {
		return findStartKeys("findByTeamAndDate", startKey, endKey, limit, skip, descending, useFactory);
	}

	public List<Activity> findByProjectAndDate(List startKey, List endKey, int limit, int skip, boolean descending,
			boolean useFactory) throws ServiceError {
