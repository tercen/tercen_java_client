...
public URI getBaseUri() { return URI.create("api/v1/workflow");}
String getServiceName() {return "Workflow";}

LinkedHashMap toJson(Workflow object) { return object.toJson();}
public Workflow fromJson(LinkedHashMap m,boolean useFactory) { if (m == null) return null; if (useFactory) return WorkflowBase.fromJson(m); return new Workflow(m);}
