...
public URI getBaseUri() { return URI.create("api/v1/rlib");}
String getServiceName() {return "RLibrary";}

LinkedHashMap toJson(RLibrary object) { return object.toJson();}
public RLibrary fromJson(LinkedHashMap m,boolean useFactory) { if (m == null) return null; if (useFactory) return RLibraryBase.fromJson(m); return new RLibrary(m);}
...
public List<RLibrary> findByOwnerNameVersion(List startKey,List endKey, int limit , int skip , boolean descending , boolean useFactory) throws ServiceError{
