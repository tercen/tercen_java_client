...
public class FileServiceBase extends HttpClientService<FileDocument> {
	...
	LinkedHashMap toJson(FileDocument object) {
		return object.toJson();
	}

	public FileDocument fromJson(LinkedHashMap m, boolean useFactory) {
		if (m == null)
			return null;
		if (useFactory)
			return FileDocumentBase.fromJson(m);
		return new FileDocument(m);
	}

	public List<FileDocument> findFileByWorkflowIdAndStepId(List startKey, List endKey, int limit, int skip,
	...
	public List<FileDocument> findFileByTaskId(List startKey, List endKey, int limit, int skip, boolean descending,
	...
	public List<FileDocument> findByDataUri(List startKey, List endKey, int limit, int skip, boolean descending,
			boolean useFactory) throws ServiceError {
