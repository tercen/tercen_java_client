...
public class TeamServiceBase extends HttpClientService<Team> {
	...
	LinkedHashMap toJson(Team object) {
		return object.toJson();
	}

	public Team fromJson(LinkedHashMap m, boolean useFactory) {
		if (m == null)
			return null;
		if (useFactory)
	...
	public List<Team> findTeamByNameByLastModifiedDate(List startKey, List endKey, int limit, int skip,
